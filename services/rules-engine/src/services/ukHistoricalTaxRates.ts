...
export const HISTORICAL_TAX_RATES: HistoricalTaxRates = {
  ...
  '2021-22': {
    ...
    corporationTax: { applicable: false, mainRate: 0.19, smallProfitsRate: 0.19, smallProfitsThreshold: 0, marginalReliefFraction: 0, marginalReliefUpperLimit: 0 },
    vat: { registrationThreshold: 85000, deregistrationThreshold: 83000, standardRate: 0.20, reducedRate: 0.05, zeroRate: true, exempt: false, flatRateScheme: true, flatRatePercentages: {} },
    capitalGainsTax: { applicable: true, annualExemptAmount: 12300, basicRate: 0.10, higherRate: 0.20, entrepreneursReliefRate: 0.10, entrepreneursReliefLifetimeLimit: 1000000 },
    filingDeadlines: { selfAssessment: '31 Jan', corporationTax: 'N/A', vat: '1 month + 7 days', paye: '19th of following month' },
    allowances: { tradingAllowance: 1000, propertyAllowance: 1000, marriageAllowance: 1260, blindPersonsAllowance: 2530 },
    reliefs: { annualInvestmentAllowance: 1000000, rndSmeRate: 1.30, rndLargeRate: 0.13, eisRate: 0.30, eisMaxInvestment: 2000000, seisRate: 0.50, seisMaxInvestment: 250000, vctRate: 0.30, pensionAnnualAllowance: 40000, pensionLifetimeAllowance: 1073100 },
  },
  '2020-21': {
    entityType: 'sole_trader',
    taxYear: '2020-21',
    ...
    capitalGainsTax: { applicable: true, annualExemptAmount: 12300, basicRate: 0.10, higherRate: 0.20, entrepreneursReliefRate: 0.10, entrepreneursReliefLifetimeLimit: 1000000 },
    filingDeadlines: { selfAssessment: '31 Jan', corporationTax: 'N/A', vat: '1 month + 7 days', paye: '19th of following month' },
    allowances: { tradingAllowance: 1000, propertyAllowance: 1000, marriageAllowance: 1250, blindPersonsAllowance: 2530 },
    reliefs: { annualInvestmentAllowance: 1000000, rndSmeRate: 1.30, rndLargeRate: 0.13, eisRate: 0.30, eisMaxInvestment: 2000000, seisRate: 0.50, seisMaxInvestment: 250000, vctRate: 0.30, pensionAnnualAllowance: 40000, pensionLifetimeAllowance: 1055000 },
  },
};
