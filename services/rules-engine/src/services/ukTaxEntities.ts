...
const TAX_YEAR_2024_25: Record<UKEntityType, EntityTaxProfile> = {
  ...
  partnership: {
    ...
    incomeTax: {
      ...TAX_YEAR_2024_25.sole_trader.incomeTax,
      // Partnerships: each partner pays tax on their share
    },
  },
  llp: {
    ...TAX_YEAR_2024_25.partnership,
    entityType: 'llp',
  },
  ltd: {
    entityType: 'ltd',
    taxYear: '2024-25',
    incomeTax: {
      applicable: false, // Directors pay personal tax on salary/dividends
      personalAllowance: 0,
    ...
    vat: {
      ...
      exempt: false,
      flatRateScheme: true,
      flatRatePercentages: TAX_YEAR_2024_25.sole_trader.vat.flatRatePercentages,
    },
    capitalGainsTax: {
      applicable: false, // Company doesn't pay CGT, shareholders do
  ...
  plc: {
    ...TAX_YEAR_2024_25.ltd,
    entityType: 'plc',
    corporationTax: {
      ...TAX_YEAR_2024_25.ltd.corporationTax,
      // PLCs typically don't qualify for small profits rate
  ...
  cic: {
    ...
    corporationTax: {
      ...TAX_YEAR_2024_25.ltd.corporationTax,
      // CICs may have different tax treatment
    },
  },
  charity: {
    entityType: 'charity',
    ...
    corporationTax: {
      applicable: true,
      mainRate: 0, // Charities exempt from Corporation Tax on charitable activities
      smallProfitsRate: 0,
      smallProfitsThreshold: 0,
      marginalReliefFraction: 0,
      marginalReliefUpperLimit: 0,
    ...
    vat: {
      ...
      reducedRate: 0.05,
      zeroRate: true,
      exempt: true, // Many charity activities are VAT exempt
  ...
  trust: {
    ...
    incomeTax: {
      applicable: true,
      personalAllowance: 0, // Trusts have different allowances
    ...
    capitalGainsTax: {
      applicable: true,
      annualExemptAmount: 1500, // Trusts have lower CGT allowance
      basicRate: 0.20,
      higherRate: 0.20,
      entrepreneursReliefRate: 0.10,
      entrepreneursReliefLifetimeLimit: 1000000,
